...
If we fix gamma = .2, how does the outbreak size change depending on the basic reproductive number R_0 = beta/gamma?
```{r}
# Define a list of time steps 
times = seq(from = 0, to = 1000, by = .1)
...
Return to the model in exercise 1. Plot R-effective and the number of infected individuals together
